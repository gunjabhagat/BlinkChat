...
function ReceiverMessage({ image, message }) {
  ...
  return (
    <div className='flex items-start gap-3'>
      ...
      <div
        ref={scroll}
        className='max-w-[480px] px-5 py-3 bg-pink-500 bg-opacity-60 text-white text-lg rounded-tl-none rounded-2xl shadow-lg shadow-pink-400/60 flex flex-col gap-2 animate-fade-in glassmorphism-pink'
      >
        {image && (
          <img
            src={image}
      ...
      <style>{`
        ...
        .glassmorphism-pink {
          ...
          border: 1.5px solid rgba(255 182 193 / 0.3); /* light pink border */
          box-shadow:
